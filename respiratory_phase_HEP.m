...
% for regression-based baseline correction do not use pop_epochbin...
% extract bin-based epochs using "RELAX" toolbox and re-import epoched .set files in EEGLAB
